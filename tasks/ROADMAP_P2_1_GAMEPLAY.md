...
| Economy and resources | `P2.1-406`, `P2.1-411`, `P2.1-413` | Steel and other progression resources can be produced through extraction/production loops; building affordability uses the selected planet inventory; switching planets changes ResourceBar scope and the full list stays available. |
