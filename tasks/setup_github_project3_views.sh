...
create_view "Roadmap P0-P5" "table" "phase:P0,P1,P1.1,P2,P2.1,P2.2,P2.3,P3,P4,P5"
create_view "Roadmap P2-P5" "table" "phase:P2,P2.1,P2.2,P2.3,P3,P4,P5"
create_view "Phase 2 Expansion" "board" "phase:P2,P2.1,P2.2,P2.3"
create_view "Phase 2.1 Gameplay" "board" "phase:P2.1"
create_view "Phase 2.2 Building Economy" "board" "phase:P2.2"
create_view "Phase 2.3 Jump Gate" "board" "phase:P2.3"
