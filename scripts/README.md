...
- When CI steps change, update `ci-verify.sh` and [.github/workflows/ci.yml](../.github/workflows/ci.yml) together. Keep the `security` job and local `npm run security:check` step aligned.
