...
- **`research-catalog.test.ts`** — validates catalog structure guarantees: every branch contains levels `1..3`, localized copy is present, and effect multipliers are positive.
