...
export const RESOURCE_CATALOG_ROWS: ResourceCatalogRow[] = [
  ...
  { id: 'military_alloy', symbol: 'SS', tier: 3, name: { ru: 'Серебряная сталь', en: 'Silver Steel' }, baseRegenRate: 0, defaultStorageCap: 1000 },
  { id: 'military_composite', symbol: 'C/SiC', tier: 3, name: { ru: 'C/SiC-композит', en: 'C/SiC Composite' }, baseRegenRate: 0, defaultStorageCap: 1000 },
];
