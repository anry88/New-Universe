...
import { expeditions, planetResources, planets, resources, ships, systems, users } from '../../db/schema.js';
...
describe('Expeditions - POST /expeditions', () => {
  ...
  it('should create an expedition and schedule eta', async () => {
    ...
    const ship = await createIdleScout(userId, planetId);
