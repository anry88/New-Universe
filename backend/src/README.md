...
- [`features/`](features/README.md) — feature modules (`auth`, `bot`, `me`, `world`, `buildings`, `resources`, `ships`, `combat`, `expeditions`, `jump-gate`, `research`, `tutorial`, `multiplayer`). Each feature owns its own route handlers, service logic, and tests.
