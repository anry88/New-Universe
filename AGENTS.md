...
- В игровых пользовательских текстах нельзя показывать task-id, slug/id сущностей, названия внутренних полей, технические пояснения реализации или агентские мета-комментарии. Для ресурсов, зданий, кораблей, исследований и статусов используйте локализованные entity-labels и человекочитаемые формулировки.
