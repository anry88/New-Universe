...
This directory contains flat JSON dictionaries for the Telegram Mini App UI. Keys are grouped by feature prefix (`common.*`, `build.*`, `market.*`, `production.*`, etc.) and consumed through `lib/i18n.tsx`.
