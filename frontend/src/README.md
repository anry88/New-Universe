...
- `components/` — reusable presentational components.
  ...
  - **`cosmic/resources.ts`** — resource id -> symbol/label dictionary used in cosmic UI; aligned with seeded resource ids (`iron`, `silicon`, `oil`, `tritium`, `jump_fuel`, etc.) for tech-tree cost rendering and falls back through `@shared/types/entity-labels` so unknown resources humanize rather than showing raw slugs.
