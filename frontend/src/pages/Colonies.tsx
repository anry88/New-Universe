    ...
    <div className="cosmic-screen" style={{ '--accent': '#5BD7FF' } as React.CSSProperties}>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6 pb-24">
        <header className="flex justify-between items-center">
          <h1 className="text-xl font-bold text-white tracking-tight">Your Colonies</h1>
        ...
        <div className="grid gap-4">
          {planets.length > 0 ? (
                    ...
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="flex items-center gap-2">
                        {!isActive ? (
                          ...
                          <span className="px-2 py-1 bg-cyan-500/10 text-cyan-400 text-[10px] font-bold uppercase rounded border border-cyan-500/20">Active</span>
                        )}
                        <button
            ...
            <div className="flex flex-col items-center justify-center py-20 text-center space-y-4">
              ...
              <div>
                <h3 className="text-slate-300 font-bold">No Colonies Yet</h3>
                <p className="text-xs text-slate-500 max-w-[200px] mt-1">Explore the system to find and colonize new worlds.</p>
              </div>
              <button
                onClick={() => navigate('/map')}
