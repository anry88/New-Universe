...
const RESOURCE_META: Record<string, ResourceMeta> = {
  ...
  oxygen: { symbol: 'O₂', full: { en: 'Oxygen', ru: 'Кислород' } },
  hydrogen: { symbol: 'H₂', full: { en: 'Hydrogen', ru: 'Водород' } },
  nitrogen: { symbol: 'N₂', full: { en: 'Nitrogen', ru: 'Азот' } },
  ...
  silver: { symbol: 'Ag', full: { en: 'Silver', ru: 'Серебро' } },
  titanium: { symbol: 'Ti', full: { en: 'Titanium', ru: 'Титан' } },
  gold: { symbol: 'Au', full: { en: 'Gold', ru: 'Золото' } },
  ice: { symbol: 'H₂O*', full: { en: 'Ice', ru: 'Лёд' } },
