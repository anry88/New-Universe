...
- Added an idempotent `0037_staging_combat_schema_repair` migration so environments that skipped `0033–0036` because of Drizzle migration timestamp drift receive the same combat/fuel schema columns without dropping data.
