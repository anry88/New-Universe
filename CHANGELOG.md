...
### Added
- `P4-ANA-001`: добавлен local-first слой продуктовой аналитики — shared taxonomy/sanitizer, backend Pino-события `analytics.event`, frontend `nu:analytics` events с optional PostHog key, focused tests и документация `docs/analytics/events.md`. P4-MON-001 отложена до завершения аналитики; в task metadata зафиксированы пожелания по Telegram Stars diamond packs.
